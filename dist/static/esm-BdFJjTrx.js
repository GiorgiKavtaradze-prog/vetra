...
import { n } from "./dist-BAVtJnuf.js";
var r = e(t(), 1),
  i = e(n(), 1);
function a(e, t, n) {
  let r = Array(e);
...
var c = (e, t) => Math.abs(e - t) < 1.01,
  ...
  d = () => {
    ...
    if (typeof navigator > `u`) return (u = !1);
    if (/iP(hone|od|ad)/.test(navigator.userAgent)) return (u = !0);
    let e = navigator.maxTouchPoints;
    return (u = navigator.platform === `MacIntel` && e !== void 0 && e > 0);
  },
  f = (e) => {
  ...
  h = (e, t) => {
    ...
    if ((i(f(n)), !r.ResizeObserver)) return () => {};
  ...
  v = (e, t, n) => {
    ...
    if (!i) return;
    let a = e.options.useScrollendEvent && _,
      o = 0,
      s = a ? null : l(i, () => t(o, !1), e.options.isScrollingResetDelay),
      c = (e) => () => {
        ((o = n(r)), s?.(), t(o, e));
      },
      u = c(!0),
      d = c(!1);
    return (
      r.addEventListener(`scroll`, u, g),
      a && r.addEventListener(`scrollend`, d, g),
      () => {
        (r.removeEventListener(`scroll`, u),
          a && r.removeEventListener(`scrollend`, d),
          s?.cancel());
      }
    );
  },
  ...
  S = class {
    constructor(e) {
      ((this.unsubs = []),
        ...
        (this.now = () => {
          var e;
          return (
            (e = this.targetWindow?.performance)?.now?.call(e) ?? Date.now()
          );
        }),
        (this.observer = (() => {
          let e = null,
        ...
        (this.setOptions = (e) => {
          ...
          if (
            ...
            if (
              ...
              (e > 0 &&
                o > 0 &&
                (t.getItemKey(0) !== c || t.getItemKey(o - 1) !== l))
            ) {
              a = !0;
              let c =
                e > 0
              ...
              let u =
                t.followOnAppend === !0 ? `auto` : t.followOnAppend || null;
              u &&
                o > e &&
          ...
          ((this.options = t),
            a && ((this.pendingMin = 0), this.itemSizeCacheVersion++));
          let o = !1,
            s = 0;
          ...
          (o || i) &&
            (this.pendingScrollAnchor = [o ? r[0] : null, o ? r[1] : 0, i, s]);
        }),
        (this.notify = (e) => {
          var t, n;
        ...
        (this._willUpdate = () => {
          ...
          if (this.scrollElement !== e) {
            ...
            if (
              ...
              (e.addEventListener(`touchstart`, t, g),
                e.addEventListener(`touchend`, n, g),
                this.unsubs.push(() => {
          ...
          if (
            ((this.pendingScrollAnchor = null),
            t && this.scrollElement && this.options.enabled)
          ) {
            let [e, n, r, i] = t;
            (e !== null &&
              !r &&
          ...
          (
            ...
            if (
              ...
              for (let t = d; t < e; t++) {
                ...
                ((o[t * 2] = s), (o[t * 2 + 1] = i), (s += i + c));
              }
              let l = a(e, o, r);
              return ((this.measurementsCache = l), l);
            }
            let f = this.measurementsCache.slice(0, d),
            ...
            for (let i = d; i < e; i++) {
              let e = r(i),
                ...
                l,
                d,
                g = s === `estimate` || u.has(e);
              if (a !== void 0 && this.options.lanes > 1) {
                l = a;
                let e = p[l],
                  r = e === void 0 ? void 0 : f[e];
                d = r ? r.end + c : t + n;
              } else if (h === o) {
                let e = 0,
                  t = m[0],
                ...
                ((l = e), (d = t + c), g && this.laneAssignments.set(i, l));
              } else
                ((l = i % this.options.lanes),
                  (d = t + n),
                  g && this.laneAssignments.set(i, l));
              let _ = u.get(e),
          ...
          (e, t, n, r) =>
            e.length === 0 || t === 0
              ...
              : ((this.range = T(
                  ...
                  n,
                  r,
                  r === 1 && this._flatMeasurements != null
        ...
        (this.shouldMeasureDuringScroll = (e) => {
          ...
          let t =
            ...
            this.getVirtualItemForOffset(this.scrollState.lastTargetOffset)
              ?.index;
        ...
        (this.resizeItem = (e, t) => {
          ...
          if (s !== 0) {
            ...
            ((this.pendingMin === null || e < this.pendingMin) &&
              (this.pendingMin = e),
        ...
        (this.getVirtualItemForOffset = (e) => {
          ...
          return s(
            t[
              C(0, t.length - 1, r ? (e) => n[e * 2] : (e) => s(t[e]).start, e)
            ],
          );
        }),
    ...
    reconcileScroll() {
      ...
      if (!n && c(t, this.getScrollOffset())) {
        if (
          (this.scrollState.stableFrames++, this.scrollState.stableFrames >= 1)
        ) {
...
var E = typeof document < `u` ? r.useLayoutEffect : r.useEffect;
function D({
  useFlushSync: e = !0,
  ...
  ((s.current.enabled = t), (s.current.mode = n));
  let c = (e) => {
      let t = s.current;
    ...
    l = (e) => {
      ...
      let n = !!e.options.horizontal,
        r = t.mode === `transform`,
        i = n ? `left` : `top`,
        a = e.options.scrollMargin,
        o = e.getVirtualItems();
      for (let s of o) {
        let o = s.start - a,
          c = e.elementsCache.get(s.key);
        c &&
    ...
    u = {
      ...
      onChange: (t, n) => {
        ...
        (u && (e && n ? (0, i.flushSync)(o) : o()),
          (r = a.onChange) == null || r.call(a, t, n));
      },
    },
    [d] = r.useState(() => {
      let e = new S(u);
...
export { b as i, m as n, x as r, O as t };
