...
var n = e((e, n) => {
  ...
  function C(e) {
    return (
      (v.ReactCurrentDispatcher.current = e),
      v.ReactCurrentDispatcher.current
    );
  }
  var w = [];
  function T(e) {
    let t = v.ReactCurrentDispatcher.current;
    if (e === 0) {
      if ((w.push(t), w.length === 1 && (S = t), t === x))
        throw Error(
      ...
      (w.length === 0 && (S = null), C(e));
    } else if (e === 2) (w.push(t), C(S));
    else if (e === 3) {
      let e = w.pop();
      if (e == null)
        throw Error(
  ...
  function E(e) {
    for (let t = 0; t < e.length; t++) e[t] = y;
  }
  function D() {
      ...
      if (!(r > 2) && e !== t) {
        if (typeof e != typeof t)
          ...
          if (e === null && t !== null) o(`null`, `type ${typeof t}`, n, r);
            ...
            if (!(t instanceof Map)) o(`Map instance`, `other value`, n, r);
              ...
              for (let [i, a] of e)
                t.has(i)
                  ? s(a, t.get(i), `${n}.get(${i})`, r + 1)
                  : o(
                      `Map instance with key ${i}`,
                      `Map instance without key ${i}`,
                      n,
                      r,
                    );
          } else if (t instanceof Map) o(`other value`, `Map instance`, n, r);
          else if (e instanceof Set) {
            if (!(t instanceof Set)) o(`Set instance`, `other value`, n, r);
            else if (e.size !== t.size)
              o(
              ...
              for (let i of t)
                e.has(i) ||
                  o(
                    `Set instance without element ${i}`,
                    `Set instance with element ${i}`,
                    n,
                    r,
                  );
            ...
            _(e) === _(t)
              ? e.type === t.type
                ? s(e.props, t.props, `[props of ${n}]`, r + 1)
                : o(
                    `React element of type ${e.type}`,
                    `React element of type ${t.type}`,
                    n,
                    r,
                  )
              : o(
                  `type ${_(e) ? `React element` : `object`}`,
            ...
            for (let i in t)
              i in e ||
                o(`object without key ${i}`, `object with key ${i}`, n, r);
            for (let i in e)
              i in t
                ? s(e[i], t[i], `${n}.${i}`, r + 1)
                : o(`object with key ${i}`, `object without key ${i}`, n, r);
          }
        } else if (typeof e == `function`) return;
        else
          isNaN(e) || isNaN(t)
            ? isNaN(e) !== isNaN(t) &&
              o(
