var e = {
  ...
  "namespaced-call": {
    ...
    inside: {
      namespace: { pattern: /^[a-zA-Z_]\w*/, alias: `class-name` },
      "namespace-separator": { pattern: /::/, alias: `operator` },
      "namespaced-function": { pattern: /[a-zA-Z_]\w*$/, alias: `function` },
    },
  },
  variable: /\$[a-zA-Z_]\w*/,
  "special-variable": { pattern: /@|\^+/, alias: `variable` },
  wildcard: { pattern: /\*(?=\s*[\[{|])/, alias: `variable` },
  spread: { pattern: /\.\.\./, alias: `operator` },
  dereference: { pattern: /->/, alias: `operator` },
  pipe: { pattern: /\|(?!\|)/, alias: `operator` },
  operator: /=>|[!=<>]=|&&|\|\||[!+\-*/%]|\*\*|\.\.(?!\.)/,
  punctuation: /[[\]{}(),:;]/,
  accessor: { pattern: /\./, alias: `punctuation` },
