...
function c(e, t, n = `auto`) {
  return n === !0 || (n === `auto` && (o(e) || s(e))) ? e : `${e}${a(t)}`;
}
(Object.fromEntries(Object.entries(r).map((e) => [e[1], +e[0]])),
  Object.fromEntries(Object.entries(t).map((e) => e.reverse())));
var l = `${Object.values(t)
    .map((e) => `\\u{${e.toString(16)}}`)
    .join(``)}`,
  u = RegExp(`[${l}]{4,}`, `gu`);
function d(e) {
  return { cleaned: e.replace(u, ``), encoded: e.match(u)?.[0] || `` };
}
function f(e) {
  return e && JSON.parse(d(JSON.stringify(e)).cleaned);
}
function p(e) {
  return f(e);
}
export { p as n, c as r, e as t };
